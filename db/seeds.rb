...
Subplan.create!([{name: "Monthly", price: 100, services_commited: 2, plan_id: 1}, {name: "Quaterly", price: 85, services_commited: 6, plan_id: 1}, {name: "Half Yearly", price: 75, services_commited: 12, plan_id: 1}, {name: "Monthly", price: 100, services_commited: 2, plan_id: 2}, {name: "Quaterly", price: 85, services_commited: 6, plan_id: 2}, {name: "Half Yearly", price: 75, services_commited: 12, plan_id: 2}])
